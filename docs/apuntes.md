...
**Dato adicional**: `obs-websocket-js` v5 funciona en navegador porque solo
depende de `WebSocket` global y `crypto.subtle` para el handshake de
autenticación SHA-256, ambos nativos del navegador.
